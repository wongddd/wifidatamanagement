...
<template>
  <el-card>
    ...
    <!-- 编辑弹窗 -->
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑会员' : '新增会员'" width="90%" style="max-width:480px">
    ...
    <!-- 充值弹窗 -->
    <el-dialog v-model="rechargeVisible" title="会员充值" width="90%" style="max-width:380px">
